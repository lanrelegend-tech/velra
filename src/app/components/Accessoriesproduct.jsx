    ...
    <div className="w-full py-20 px-10 font-sans text-black">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        ...
        <div className="bg-white flex flex-col hover:scale-105 transition duration-300 shadow-sm">
          <img src="/ass1.jpg" className="w-full h-72 object-cover" />
        ...
        <div className="bg-white flex flex-col hover:scale-105 transition shadow-sm">
          <img src="/ass2.jpg" className="w-full h-72 object-cover" />
          <div className="p-3 flex flex-col gap-2 items-center">
            <button className="bg-black text-white px-6 py-2 text-xs tracking-widest mt-2 hover:opacity-80 transition">
              QUICK VIEW
            </button>
        ...
        {/* CARD 3 */}
        <div className="bg-white flex flex-col hover:scale-105 transition shadow-sm">
          <img src="/ass3.jpg" className="w-full h-72 object-cover" />
          <div className="p-3 flex flex-col gap-2 items-center">
            <button className="bg-black text-white px-6 py-2 text-xs tracking-widest mt-2 hover:opacity-80 transition">
              QUICK VIEW
            </button>
        ...
        {/* CARD 4 */}
        <div className="bg-white flex flex-col hover:scale-105 transition shadow-sm">
          <img src="/ass4.jpg" className="w-full h-72 object-cover" />
          <div className="p-3 flex flex-col gap-2 items-center">
            <button className="bg-black text-white px-6 py-2 text-xs tracking-widest mt-2 hover:opacity-80 transition">
              QUICK VIEW
            </button>
        ...
        {/* CARD 5 */}
        <div className="bg-white flex flex-col hover:scale-105 transition shadow-sm">
          <img src="/ass5.jpg" className="w-full h-72 object-cover" />
          <div className="p-3 flex flex-col gap-2 items-center">
            <button className="bg-black text-white px-6 py-2 text-xs tracking-widest mt-2 hover:opacity-80 transition">
              QUICK VIEW
            </button>
        ...
        {/* CARD 6 */}
        <div className="bg-white flex flex-col hover:scale-105 transition shadow-sm">
          <img src="/ass6.jpg" className="w-full h-72 object-cover" />
          <div className="p-3 flex flex-col gap-2 items-center">
            <button className="bg-black text-white px-6 py-2 text-xs tracking-widest mt-2 hover:opacity-80 transition">
              QUICK VIEW
            </button>
